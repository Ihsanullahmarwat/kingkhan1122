...
if(isset($_POST['enroll'])){
  ...
  $query ="SELECT * FROM `classes` WHERE class_id='$cid' AND class_key='$uniquekey'";
  ...
  if (mysqli_num_rows($results) == 1) {
    ...
    $query="INSERT INTO keytable (student_email, class_id) VALUES ('$email','$cid')";
...
<h2>&nbsp Classes</h2>
   ...
   while($user = mysqli_fetch_assoc($result)){
     ...
     $query3="
     SELECT class_id,class_name,teachers.teacher_name FROM classes 
