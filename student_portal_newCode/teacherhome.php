      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
             ...
             include('db_connection.php');
              $query="SELECT `file_id`, `class_id`, `file_name`, `file_path`, `file_type` FROM `files` WHERE class_id='$cid'";
                ...
                if (mysqli_num_rows($result)>0) {
                   ...
                   <tr>
                     ...
                     <td><?php  echo '<a href="openfile.php?open='.$filepath.'"><div height=40px>'.$file.'</div></a>'; ?></td>
                   </tr>
...
<h2>&nbsp Classes</h2>
   <?php
    ...
    if (!(is_null($teacheremail))) {
      $query="SELECT `class_id`, `class_key`, `teacher_email`, `class_name` FROM `classes` WHERE teacher_email='$teacheremail'";
      $result = mysqli_query($conn, $query);?>
    ...
    <th>Show Files from here</th>
      ...
      while($row= mysqli_fetch_assoc($result)){
          ...
          <tr>
            ...
            <td><?php echo $row['class_key'];  ?></td>
            <td><a href="fileupload.php?cid=<?php echo $cid; ?>" >add files</a></td>
            <td><form action="#tb" method="post"><button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal" value="<?php echo $cid; ?>">Click</button> </form></td>
          </tr>
